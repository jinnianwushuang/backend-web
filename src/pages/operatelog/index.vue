 ...
 * @FilePath       : /backend-web/src/pages/operatelog/index.vue
 * @Description    : 
-->
<template>
...
export default {
  ...
  created() {
    ...
    if( this.is_component){
      ...
      console.log('this.component_data',this.component_data);
      console.log('this.component_data',this.component_data.value);
  ...
  methods: {
    init_table_data() {
      ...
      api_operatelog.post_log_queryOperateLog(params).then((res) => {
